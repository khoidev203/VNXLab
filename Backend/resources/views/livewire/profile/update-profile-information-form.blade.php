...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $this->phone = Auth::user()->phone ?? ''; // Cung cấp giá trị mặc định nếu không có giá trị
        $this->address = Auth::user()->address ?? ''; // Cung cấp giá trị mặc định nếu không có giá trị
    ...
    public function updateProfileInformation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'avatar' => ['nullable', 'image', 'max:1024'], // Validate avatar
        ]);
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            @if ($avatar)
                <div class="mt-2">
                    <img src="{{ asset('storage/' .$avatar) }}" alt="Avatar" class="w-24 h-24 object-cover rounded-full">
                </div>
            @endif
